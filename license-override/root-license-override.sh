...
COMP_OWNER=conan
COMP_VERSION=1.2.11
LICENSE_IDS='"AGEL","Amazon","AGPL-2.0","Beerware"'

curl -u ${IQUSER}:${IQPWD} "${IQURL}/rest/licenseOverride/organization/ROOT_ORGANIZATION_ID?timestamp=1628261106310" \
